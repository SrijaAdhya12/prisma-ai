		...
		<section id="quote" className="to-background w-full bg-gradient-to-b from-purple-900 py-5">
			<div className="container mx-auto my-24 text-center">
				...
				<p className="my-10 text-xl leading-relaxed text-slate-500 sm:px-48">
					Introducing Prisma AI providing personalized mental health support tailored to each user&apos;s
					unique emotional needs. Using advanced mood analysis, it suggests activities and coping strategies
					based on the user&apos;s current state of mind
				</p>
			</div>
		</section>
	)
