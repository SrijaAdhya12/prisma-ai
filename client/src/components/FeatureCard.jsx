		...
		<div className="w-full max-w-xs">
			...
			>
				...
				<img
					src={background}
					alt={title}
					className="absolute left-0 top-0 h-full object-cover brightness-90 transition-opacity duration-500 group-hover:opacity-0 w-full"
				/>
				<div className="text relative z-50 group-hover:opacity-0">
					<h1 className="relative text-xl font-bold md:text-3xl">{title}</h1>
					<p className="relative my-4 text-base font-normal">{description}</p>
				</div>
			</Link>
		</div>
	)
